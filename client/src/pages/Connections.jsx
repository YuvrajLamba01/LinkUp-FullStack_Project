                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    {
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer"
                      >
                        View Profile
                      </button>
                    }
                    {currentTab === "Following" && (
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-slate-100 text-black active:scale-95 transition cursor-pointer"
                      >
                        Unfollow
                      </button>
                    )}
